...
repo_owner = "khulnasoft-labs"
repo_name = "vulscan-templates"
pr_user_list = ["DhiyaneshGeek", "pussycat0x", "ritikchaddha", "sulaiman-coder"]
issue_user_list = ["princechaddha", "DhiyaneshGeek", "pussycat0x", "ritikchaddha", "sulaiman-coder"]
